...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button group/menu-button relative flex w-full items-center gap-2.5 overflow-hidden rounded-md p-2 text-start text-sm text-sidebar-foreground ring-sidebar-ring outline-hidden transition-colors group-has-data-[sidebar=menu-action]/menu-item:pe-8 group-data-[collapsible=icon]:size-9! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-brand-gradient data-active:font-medium data-active:text-sidebar-primary-foreground data-active:shadow-xs data-active:hover:text-sidebar-primary-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-current [&>span:last-child]:truncate',
  {
    variants: {
      variant: {
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        // Collapsed-sidebar tooltips must open away from the sidebar in both directions.
        side={
